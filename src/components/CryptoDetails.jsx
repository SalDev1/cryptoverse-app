...
const CryptoDetails = () => {
  ...
  // const volume = cryptoDetails ? cryptoDetails['24hVolume'] : "0"; 

  // const convertHTMLtoPlain = (string) => {
  ...
  const stats = [
    ...
    { title: '24h Volume', value: `$ ${cryptoDetails ? millify(cryptoDetails['24hVolume']) : millify("0")}`, icon: <ThunderboltOutlined /> },
  ...
  <Col className='coin-detail-container'>
      ...
      <Col className = "coin-desc-link" lg = {24}>
